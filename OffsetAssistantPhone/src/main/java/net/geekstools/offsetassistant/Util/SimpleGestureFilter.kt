package net.geekstools.offsetassistant.Util
...
class SimpleGestureFilter(context: Context, private val listener: SimpleGestureListener) : SimpleOnGestureListener() {
    var swipeMinDistance = 50
    var swipeMaxDistance = 1000
    var swipeMinVelocity = 50
